...
namespace NVorbis
{
    ...
    public static class Extensions
    {
        ...
        public static byte[] ReadBytes(this Packet packet, int count)
        {
        ...
        public static byte PeekByte(this Packet packet)
        {
        ...
        public static short ReadInt16(this Packet packet)
        {
        ...
        public static int ReadInt32(this Packet packet)
        {
        ...
        public static long ReadInt64(this Packet packet)
        {
        ...
        /// <param name="packet"></param>
        /// <returns>The value of the next 16 bits.</returns>
        public static ushort ReadUInt16(this Packet packet)
        {
        ...
        /// <param name="packet"></param>
        /// <returns>The value of the next 32 bits.</returns>
        public static uint ReadUInt32(this Packet packet)
        {
        ...
        /// <param name="packet"></param>
        /// <returns>The value of the next 64 bits.</returns>
        public static ulong ReadUInt64(this Packet packet)
        {
        ...
        public static void SkipBytes(this Packet packet, int count)
        {
