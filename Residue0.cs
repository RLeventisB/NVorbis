...
namespace NVorbis
{
    ...
    public class Residue0 : IResidue
    {
        ...
        int[] _cascade;
        int[][] _decodeMap;
        virtual public void Init(Packet packet, int channels, Codebook[] codebooks)
        {
        ...
        virtual public void Decode(Packet packet, bool[] doNotDecodeChannel, int blockSize, float[][] buffer)
        {
            // this is pretty well stolen directly from libvorbis...  BSD license
        ...
        virtual protected bool WriteVectors(Codebook codebook, Packet packet, float[][] residue, int channel, int offset, int partitionSize)
        {
