...
{
    /// <summary>
    /// Implements an easy to use wrapper around <see cref="ContainerReader"/> and <see cref="StreamDecoder"/>.
    /// </summary>
    public sealed class VorbisReader : IDisposable
    {
        private readonly List<StreamDecoder> _decoders;
        private readonly ContainerReader _containerReader;
        private readonly bool _closeOnDispose;
        private StreamDecoder _streamDecoder;
        /// <summary>
        ...
        {
            _decoders = new List<StreamDecoder>();

            var containerReader = new ContainerReader(stream, closeOnDispose)
            {
        ...
        /// <summary>
        /// Gets the list of <see cref="StreamDecoder"/> instances associated with the loaded file / container.
        /// </summary>
        public IReadOnlyList<StreamDecoder> Streams => _decoders;
        ...
        /// </summary>
        public TagData Tags => _streamDecoder.Tags;
        ...
        /// </summary>
        public StreamStats StreamStats => _streamDecoder.Stats;
