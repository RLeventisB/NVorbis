...
namespace NVorbis
{
    public class Codebook
    {
        ...
        class FastRange : IReadOnlyList<int>
        {
            ...
            {
                var fr = _cachedRange ??= new FastRange();
                fr._start = start;
                fr._count = count;
                return fr;
            }
        ...
        public int[] _lengths;
        public int _prefixBitLength, _maxBits;
        public float[] _lookupTable;
        public IReadOnlyList<HuffmanListNode> _overflowList, _prefixList;
        public void Init(Packet packet, Huffman huffman)
        {
        ...
        private void InitTree(Packet packet, Huffman huffman)
        {
            bool sparse;
            int total = 0;
        ...
        static bool ComputeCodewords(bool sparse, int[] codewords, int[] codewordLengths, int[] len, int n, int[] values)
        {
            int i, k, m = 0;
        ...
        public static void AddEntry(bool sparse, int[] codewords, int[] codewordLengths, uint huffCode, int symbol, int count, int len, int[] values)
        {
            if (sparse)
            {
