...
namespace NVorbis.Ogg
{
    ...
    public delegate int GetPacketGranuleCount(Packet packet, bool isLastInPage);
    public class PacketProvider
    {
        private readonly StreamPageReader _reader;
        private int _pageIndex, _packetIndex, _lastPacketPageIndex, _lastPacketPacketIndex, _nextPacketPageIndex, _nextPacketPacketIndex;
        private Packet _lastPacket;
        /// <summary>
        /// Gets the serial number of this provider's data stream.
        /// </summary>
        public int StreamSerial { get; }
        internal PacketProvider(StreamPageReader reader, int streamSerial)
        {
        ...
        private Packet CreatePacket(ref int pageIndex, ref int packetIndex, bool advance, long granulePos, bool isResync, bool isContinued, int packetCount, int pageOverhead)
        {
            ...
            if (isLastPacket)
            {
                ...
                if (_reader.HasAllPages && finalPage == _reader._pageOffsets.Count - 1)
                {
        ...
        public Memory<byte> GetPacketData(int pagePacketIndex)
        {
        ...
        public void InvalidatePacketCache(Packet packet)
        {
