...
{
    public class PageReader : PageReaderBase
    {
        ...
        public PageReader(Stream stream, bool closeOnDispose, Func<PacketProvider, bool> newStreamCallback) : base(stream, closeOnDispose)
        {
