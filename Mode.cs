...
namespace NVorbis
{
    public class Mode
    {
        int _channels, _block0Size, _block1Size;
        bool _blockFlag;
        Mapping _mapping;
        ...
        private bool GetPacketInfo(Packet packet, bool isLastInPage, out int blockSize, out int windowIndex, out int leftOverlapHalfSize, out int packetStartIndex, out int packetValidLength, out int packetTotalLength)
        {
        ...
        public int GetPacketSampleCount(Packet packet, bool isLastInPage)
        {
